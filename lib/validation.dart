...
class TextValidationPage extends StatefulWidget {
  const TextValidationPage({super.key});

  @override
  State<TextValidationPage> createState() => _TextValidationPageState();
}

class _TextValidationPageState extends State<TextValidationPage> {
